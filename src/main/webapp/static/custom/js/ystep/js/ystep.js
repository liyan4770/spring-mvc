...
(function ($) {
    $.fn.extend({
        ...
        loadStep: function (params) {
            ...
            if (params.callback != "" && params.callback != null)  callfunst = "onclick=\"" + params.callback + "(this)\"";
            //步骤框架
            var stepHtml = "<li class='ystep-step ystep-step-undone' " + callfunst + " data-container='body' data-toggle='popover' data-placement='top' data-title='' data-content='' data-trigger='hover'>" +
                "</li>";
            //决策器
            var logic = {
                size: {
            ...
            $(this).each(function (i, n) {
                ...
                for (i = 0; i < arrayLength; i++) {
                    if (params.steps[i] != null) {
                        var _s = params.steps[i];
                        //构造步骤html
                        $stepHtml.attr("data-title", _s.title);
                        $stepHtml.attr("data-content", _s.content);
                        if ($.isNumeric(_s.flowId))
                            $stepHtml.attr("data-flowId", _s.flowId);
                        if (_s.flowKey != "" && _s.flowKey != null)
                            $stepHtml.attr("data-flowKey", _s.flowKey);
